...
function __init__()
    ...
    external_url = "https://unpkg.com/dash_websocket_component@1.0.0/dash_websocket_component/async-DashWebsocketComponent.js",
    dynamic = nothing,
    async = :true,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dash_websocket_component@1.0.0/dash_websocket_component/async-DashWebsocketComponent.js.map",
    dynamic = true,
    async = nothing,
    type = :js
),
